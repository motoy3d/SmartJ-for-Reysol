...
Ti.API.info('rows.push '  + i);
    ...
    function createRow(rank, team, point, win, draw, lose, gotGoal, lostGoal, diffGoal, aclFlg) {
        ...
        if(config.teamName == team) {
            ...
            rankLabel.color = 'black';
            teamLabel.color = 'black';
            pointLabel.color = 'black';
            winLabel.color = 'black';
            drawLabel.color = 'black';
            loseLabel.color = 'black';
            gotGoalLabel.color = 'black';
            lostGoalLabel.color = 'black';
            diffGoalLabel.color = 'black';
        }
        return row;
    }
